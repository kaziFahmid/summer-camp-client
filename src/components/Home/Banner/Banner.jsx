...
<h1 className='uppercase text-6xl  md:text-8xl mb-6 font-bold  font-abc tracking-wider '>start become your<br className='lg:block hidden'></br> best <span className='text-orange-400 '>Version</span></h1>
