...
const [isDark,setIsDark]=useState(localStorage.getItem('theme')||false)
  ...
  return (
    <div className={`flex lg:flex-row flex-col mt-4 justify-around container bg-no-repeat lg:bg-center bg-cover     ${isDark=== 'dark' ? '' : 'bg-[url(https://i.ibb.co/HtKv7Tk/unsplash-Lx-Vx-PA1-LOVM.png)]'}  pt-6 items-center `}>
