...
export default function Contactus() {
  return (
    ...
    <div className="relative flex items-top mt-32 justify-center min-h-screen   sm:items-center sm:pt-0">
                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <button type="submit" className="md:w-32 bg-pink-500 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-pink-600 transition ease-in-out duration-300">
                                Submit
                            </button>
                        </form>
                    </div>
